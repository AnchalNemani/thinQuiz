...
def age1():
    ...
    def select(event):
        ...
        for i in range(len(a)):
            if value == correct[a[i]]:
                if value == correct[14]:
                    ...
                    def playa():
                        ...
                        lifeline50.config(state=NORMAL, image=image50)
                        audiencePole.config(state=NORMAL, image=imageaud)
                        PhoneLifeLine.config(state=NORMAL,  image=imagephone)
            ...
            if value not in correct:
                ...
                break
    def lifeline50():
        lifeline50.config(image=imageNo50,state=DISABLED)
    ...
    def audiencePole():
        audiencePole.config(image=imageNoap, state=DISABLED)
    ...
    def PhoneLifeLine():
        ...
        PhoneLifeLine.config(image=noph,state=DISABLED)
    ...
    life1=Button(topFrame,image=image50,bg="Black",border=0,activebackground="black",width=180,height=110,command=lifeline50)
    life1.grid(row=0,column=0)

    #audience
    imageaud=PhotoImage(file="people.png")
    imageNoap=PhotoImage(file="Noap.png")
    audiencePole=Button(topFrame,image=imageaud,bg="Black",border=0,activebackground="black",width=180,height=110,command=audiencePole)
    audiencePole.grid(row=0,column=1)

    #phone
    imagephone=PhotoImage(file="phone.png")
    noph=PhotoImage(file="noP.png")
    PhoneLifeLine=Button(topFrame,image=imagephone,bg="Black",border=0,activebackground="black",width=180,height=110,command=PhoneLifeLine)
    PhoneLifeLine.grid(row=0,column=2)
    ...
    amountlogo=Label(rightFrame,image=amount,bg="Black")
    amountlogo.grid()
